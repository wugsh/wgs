#!/bin/sh
#
# Download all source file archives and patches for LFS 7.6
set -e
WGETLIST="\
...
http://dev.gentoo.org/~blueness/eudev/eudev-1.10.tar.gz
http://anduin.linuxfromscratch.org/sources/other/eudev-1.10-manpages.tar.bz2
http://downloads.sourceforge.net/project/e2fsprogs/e2fsprogs/v1.42.12/e2fsprogs-1.42.12.tar.gz
...
http://prdownloads.sourceforge.net/flex/flex-2.5.39.tar.bz2
...
https://www.kernel.org/pub/linux/utils/net/iproute2/iproute2-3.16.0.tar.xz
https://www.kernel.org/pub/linux/utils/kbd/kbd-2.0.2.tar.gz
https://www.kernel.org/pub/linux/utils/kernel/kmod/kmod-18.tar.xz
http://www.greenwoodsoftware.com/less/less-458.tar.gz
http://www.linuxfromscratch.org/lfs/downloads/7.6/lfs-bootscripts-20140815.tar.bz2
...
http://download.savannah.gnu.org/releases/man-db/man-db-2.6.7.1.tar.xz
https://www.kernel.org/pub/linux/docs/man-pages/man-pages-3.72.tar.xz
...
http://cpan.metacpan.org/authors/id/T/TO/TODDR/XML-Parser-2.42_01.tar.gz
http://tukaani.org/xz/xz-5.0.5.tar.xz
http://www.zlib.net/zlib-1.2.8.tar.xz
http://www.linuxfromscratch.org/patches/lfs/7.6/bash-4.3-upstream_fixes-3.patch
http://www.linuxfromscratch.org/patches/lfs/7.6/bc-1.06.95-memory_leak-1.patch
http://www.linuxfromscratch.org/patches/lfs/7.6/binutils-2.24-load_gcc_lto_plugin_by_default-1.patch
http://www.linuxfromscratch.org/patches/lfs/7.6/binutils-2.24-lto_testsuite-1.patch
http://www.linuxfromscratch.org/patches/lfs/7.6/bzip2-1.0.6-install_docs-1.patch
http://www.linuxfromscratch.org/patches/lfs/7.6/coreutils-8.23-i18n-1.patch
...
http://www.linuxfromscratch.org/patches/lfs/7.6/kbd-2.0.2-backspace-1.patch
http://www.linuxfromscratch.org/patches/lfs/7.6/mpfr-3.1.2-upstream_fixes-2.patch
http://www.linuxfromscratch.org/patches/lfs/7.6/readline-6.3-upstream_fixes-2.patch
http://www.linuxfromscratch.org/patches/lfs/7.6/sysvinit-2.88dsf-consolidated-1.patch"
cd $LFS/sources
wget -c $WGETLIST
